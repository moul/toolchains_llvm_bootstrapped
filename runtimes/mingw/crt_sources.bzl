...
# MSVCRT (msvcrt.dll) support sources from mingw-w64-crt/Makefile.am.
...
MSVCRT_SRCS = MSVCRT_ADD_VSCANF_SRCS + [
    "misc/__iswcsym.c",
    "misc/__iswcsymf.c",
...
MSVCRT_EXTRA_X86_64_SRCS = MSVCRT_SRCS + MSVCRT_ADD_X86_SRCS + [
    "misc/__daylight.c",
    "misc/__dstbias.c",
    "misc/__p___argc.c",
    "misc/__p___argv.c",
...
MSVCRT_EXTRA_AARCH64_SRCS = MSVCRT_SRCS + [
