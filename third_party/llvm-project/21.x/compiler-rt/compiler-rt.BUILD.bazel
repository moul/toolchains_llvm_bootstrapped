...
load("@toolchains_llvm_bootstrapped//third_party/llvm-project/21.x/compiler-rt:targets.bzl", "atomic_helper_cc_library")
load("@toolchains_llvm_bootstrapped//third_party/llvm-project/21.x/compiler-rt:filter_builtin_sources.bzl", "filter_builtin_sources")
